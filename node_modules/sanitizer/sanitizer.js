...
var html = (function(html4) {
   ...
   * }}
    ...
    function safeUri(uri, effect, ltype, hints, naiveUriRewriter) {
        ...
        try {
            console.error('uri to rewrite: ', arguments);
            ...
            if (atype !== null) {
                switch (atype) {
                    ...
                    case html4.atype['URI']:
                        console.error('valuuuue', value, tagName, attribName);
                        value = safeUri(value,
    ...
    function makeTagPolicy(
        ...
        return function(tagName, attribs) {
            if (!(html4.ELEMENTS[tagName] & html4.eflags['UNSAFE'])) {
                console.error('tag policy', tagName, attribs);
                return {
...
Sanitizer.sanitize = function(inputHtml, opt_naiveUriRewriter, opt_nmTokenPolicy, opt_logger) {
    ...
    console.error('part 2', inputHtml);
